...
export interface ApiGlobalOptionGlobalOption extends Struct.SingleTypeSchema {
  collectionName: 'global_options';
  info: {
    description: 'Global site settings including header and footer';
    displayName: 'Global Options';
    pluralName: 'global-options';
    singularName: 'global-option';
  };
  options: {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    site: Schema.Attribute.Component<'shared.site-info', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiMenuMenu extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Navigation menus (WordPress-style: pages/properties auto-available)';
    displayName: 'Menu';
    pluralName: 'menus';
    singularName: 'menu';
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::global-option.global-option': ApiGlobalOptionGlobalOption;
